...
//=========================================================================================================
//=========================================================================================================
// DOUBLE PRECISION EXTERNAL C CODE (NEAREST TIME INSTANCE)
//=========================================================================================================
//=========================================================================================================
int c_delayAndSum_Algorithm_nearest_DP_CPU(
...

{
    ...
    int point=0, scan=0,lookup_index=0,t_ind=0,r_ind=0,set_val=0,pixie=0,point2=0,lbool=0;
    double tot_real1=0,tot_imag1=0,amp_corr=0,lookup_time=0,t0forRounding=t0-0.5/invdt;
