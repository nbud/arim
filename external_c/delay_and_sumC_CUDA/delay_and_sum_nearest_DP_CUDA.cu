...
//=========================================================================================================
//=========================================================================================================
// (GPU Cuda Kernel) Double Precision Delay and Sum Algorithm, using nearest time point match 
//=========================================================================================================
//=========================================================================================================
__global__ void c_delay_and_sum_amplitudes_nearest_Kernel_DP( const double* scanlines,  const unsigned int* tx,  const unsigned int* rx,  const double* lookup_times_tx,  const double* lookup_times_rx,
                ...
                int numpoints,int numsamples,int numelements, int numscanlines)
{
    ...
    if (point < numpoints)
    {
        ...
        double tot_real1,tot_imag1,amp_corr,lookup_time,t0forRounding=t0-0.5/invdt;
        tot_real1=0.0;
        tot_imag1=0.0;
...
//=========================================================================================================
//=========================================================================================================
int c_delayAndSum_Algorithm_nearest_DP_CUDA(
...

{
    ...
    cudaOccupancyMaxPotentialBlockSize(&minGridSize, &blockSize, c_delay_and_sum_amplitudes_nearest_Kernel_DP, 0, numpoints); 
    // Round up according to array size 
    gridSize = (numpoints + blockSize - 1) / blockSize; 

    // Perform Kernel Operations
    //=========================================================================
    c_delay_and_sum_amplitudes_nearest_Kernel_DP<<<gridSize, blockSize>>>(scanlines_gpu,tx_gpu,rx_gpu,lookup_times_tx_gpu,lookup_times_rx_gpu,
